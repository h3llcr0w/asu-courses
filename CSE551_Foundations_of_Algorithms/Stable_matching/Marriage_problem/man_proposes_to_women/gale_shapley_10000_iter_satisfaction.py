...
men_avg_satisfaction = list()
women_avg_satisfaction = list()


for expt in range(10000):
...
#    print("Average matching satisfaction for women: {0}".format(sum(women_satisfaction)/num_pairs))
    men_avg_satisfaction.append(sum(men_satisfaction)/num_pairs)
    women_avg_satisfaction.append(sum(women_satisfaction)/num_pairs)

print("Average satisfaction over 10000 iterations:")
print("Men: {0:0.2f}".format(sum(men_avg_satisfaction)/len(men_avg_satisfaction)))
print("Women: {0:0.2f}".format(sum(women_avg_satisfaction)/len(women_avg_satisfaction)))
