...
# * Basic algorithm with hardcoded values for 5 pairs #
#                                                     #
...
## List of people
men_list = ['Victor', 'Wyatt', 'Xavier', 'Yancey', 'Zeus']
women_list = ['Amy', 'Bertha', 'Claire', 'Diane', 'Erica']
